...
pub fn elite_scan_drive_lazy(app: &tauri::AppHandle, drive_letter: &str) -> Result<EliteMaps, String> {
    ...
    println!("ELITE LAZY: MFT Scan complete in ~5s. Stored {} entries.", name_map.len());
