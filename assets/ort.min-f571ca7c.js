...
`)},type:h,offsetToIndices:$,indicesToOffset:x,broadcastedIndicesToOffset:G,indices:I,indicesGet:E,indicesSet:A,set:(...T)=>{if(T.length!==n+1)throw new Error(`indices length must be ${n}`);let C=T[n];if(typeof C!="string")throw new Error("value must be string");let Q=T.slice(0,n).map(c).join(",");return n===0?U("0u",C):n===1?U(Q[0],C):(f.set=!0,f.setByIndices=!0,f.indicesToOffset=!0,`set_${e}(${Q}, ${C})`)},setByOffset:U,setByIndices:(T,C)=>n<2?U(T,C):(f.setByIndices=!0,f.indicesToOffset=!0,`set_${e}ByIndices(${T}, ${C});`),get:j,getByOffset:V,getByIndices:J,usage:r,name:e,strides:_,shape:y,rank:n}},S=(e,t,i,r=1)=>pt(e,t,i,"input",r),B=(e,t,i,r=1)=>pt(e,t,i,"output",r),Ca=(e,t,i)=>pt(e,t,i,"atomicOutput",1),ki=(e,t,i,r=1)=>pt(e,t,i,"internal",r),Oa=class{constructor(e,t){this.normalizedDispatchGroup=e,this.limits=t,this.internalVariables=[],this.variables=[],this.uniforms=[],this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(e){return`if (global_idx >= ${typeof e=="number"?`${e}u`:e}) { return; }`}mainStart(e=et){let t=typeof e=="number"?e:e[0],i=typeof e=="number"?1:e[1],r=typeof e=="number"?1:e[2];if(t>this.limits.maxComputeWorkgroupSizeX||i>this.limits.maxComputeWorkgroupSizeY||r>this.limits.maxComputeWorkgroupSizeZ)throw new Error(`workgroup size [${t}, ${i}, ${r}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`);if(t*i*r>this.limits.maxComputeInvocationsPerWorkgroup)throw new Error(`workgroup size [${t}, ${i}, ${r}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`);let a=this.normalizedDispatchGroup[1]===1&&this.normalizedDispatchGroup[2]===1,s=a?`@builtin(global_invocation_id) global_id : vec3<u32>,
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Aa=(e,t)=>new Oa(e,t)}),Ba,Si,Ra,Da,Ma,Ua,fe,Pa,Na,Ae=z(()=>{P(),q(),te(),L(),Ba=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Si=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Ra=(e,t)=>k.sortBasedOnPerm(e,Si(e.length,t)),Da=(e,t,i,r)=>{let a=`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
    var a: ${i.type.indices};`;for(let s=0;s<t;++s)a+=`a[${e[s]}]=i[${s}];`;return a+="return a;}"},Ma=(e,t)=>{let i=[],r=[];for(let a=0;a<e.length;++a)e[a]!==1&&i.push(e[a]),e[t[a]]!==1&&r.push(t[a]);return{newShape:i,newPerm:r}},Ua=(e,t)=>{let i=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<i)return!1;i=e[r]}return!0},fe=(e,t)=>{let i=e.dataType,r=e.dims.length,a=Si(r,t),s=Ra(e.dims,a),n=e.dims,o=s,u=r<2||Ua(a,e.dims),l;if(u)return l=f=>{let m=S("input",i,n,4),y=B("output",i,o,4);return`
  ${f.registerUniform("output_size","u32").declareVariables(m,y)}
  ${f.mainStart()}
    ${f.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let f=k.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(f/4)}]}},getShaderSource:l};let{newShape:d,newPerm:p}=Ma(e.dims,a),h=k.areEqual(p,[2,3,1]),c=k.areEqual(p,[3,1,2]);if(d.length===2||h||c){n=h?[d[0],d[1]*d[2]]:c?[d[0]*d[1],d[2]]:d,o=[n[1],n[0]];let f=16;return l=m=>{let y=S("a",i,n.length),_=B("output",i,o.length);return`
    ...
    ${y.setByOffset("global_idx",m.getByIndices("aIndices"))}
  }`},{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let f=k.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...D(n,o)]}},getShaderSource:l}},Pa=(e,t)=>{Ba(e.inputs,t.perm),e.compute(fe(e.inputs[0],t.perm))},Na=e=>Z({perm:e.perm})}),qa,Va,La,Ga,Wa,Ha,Fa,ja,Ka,Qa,be,Za,Xa,Ya,Ja,en,tn,rn,an,nn,sn,cp=z(()=>{P(),q(),L(),Ti(),Ae(),qa={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},Va={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},La={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},Ga={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},Wa=(e,t)=>{let i=[];for(let r=t-e;r<t;++r)i.push(r);return i},Ha=(e,t)=>{let i=[],r=e.length;for(let s=0;s<r;s++)t.indexOf(s)===-1&&i.push(e[s]);let a=t.map(s=>e[s]);return[i,a]},Fa=(e,t)=>{let i=e.length+t.length,r=[],a=0;for(let s=0;s<i;s++)t.indexOf(s)===-1?r.push(e[a++]):r.push(1);return r},ja=(e,t)=>{for(let i=0;i<e.length;++i)if(e[e.length-i-1]!==t-1-i)return!1;return!0},Ka=(e,t)=>{let i=[];if(!ja(e,t)){for(let r=0;r<t;++r)e.indexOf(r)===-1&&i.push(r);e.forEach(r=>i.push(r))}return i},Qa=(e,t,i,r,a,s,n)=>{let o=i[0].dims,u=k.size(s),l=k.size(n),d=S("_A",i[0].dataType,o),p=B("output",a,s),h=64;u===1&&(h=256);let c=`
       ...
       `,f=m=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${p.setByOffset("outputIndex",`${r==="mean"?`${p.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${p.type.storage}(${Ga[r]})`}`)};
         }
        }`;return{name:e,shaderCache:{hint:`${t};${h}`,inputDependencies:["type"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},be=(e,t,i,r)=>{let a=e.inputs.length===1?i:Ii(e.inputs,i),s=a.axes;s.length===0&&!a.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((c,f)=>f));let n=k.normalizeAxes(s,e.inputs[0].dims.length),o=n,u=e.inputs[0],l=Ka(o,e.inputs[0].dims.length);l.length>0&&(u=e.compute(fe(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],o=Wa(o.length,u.dims.length));let[d,p]=Ha(u.dims,o),h=d;a.keepDims&&(h=Fa(d,n)),e.compute(Qa(t,a.cacheKey,[u],r,e.inputs[0].dataType,h,p),{inputs:[u]})},Za=(e,t)=>{be(e,"ReduceMeanShared",t,"mean")},Xa=(e,t)=>{be(e,"ReduceL1Shared",t,"l1")},Ya=(e,t)=>{be(e,"ReduceL2Shared",t,"l2")},Ja=(e,t)=>{be(e,"ReduceLogSumExpShared",t,"logSumExp")},en=(e,t)=>{be(e,"ReduceMaxShared",t,"max")},tn=(e,t)=>{be(e,"ReduceMinShared",t,"min")},rn=(e,t)=>{be(e,"ReduceProdShared",t,"prod")},an=(e,t)=>{be(e,"ReduceSumShared",t,"sum")},nn=(e,t)=>{be(e,"ReduceSumSquareShared",t,"sumSquare")},sn=(e,t)=>{be(e,"ReduceLogSumShared",t,"logSum")}}),ve,on,Rt,Ii,xe,un,ln,dn,pn,hn,cn,fn,mn,gn,_n,ke,yn,$n,wn,bn,vn,xn,kn,Sn,In,Tn,Ti=z(()=>{P(),q(),te(),L(),cp(),ve=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},on=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Rt=(e,t,i,r,a,s,n=!1,o=!1)=>{let u=[],l=i[0].dims,d=l.length,p=k.normalizeAxes(a,d),h=!o&&p.length===0;l.forEach((m,y)=>{h||p.indexOf(y)>=0?n&&u.push(1):u.push(m)});let c=u.length,f=k.size(u);return{name:e,shaderCache:t,getShaderSource:m=>{let y=[],_=S("_A",i[0].dataType,d),g=B("output",s,c),w=r(_,g,p),$=w[2];for(let b=0,v=0;b<d;b++)h||p.indexOf(b)>=0?(n&&v++,$=`for(var j${b}: u32 = 0; j${b} < ${l[b]}; j${b}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:u,dataType:s}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...D(l,u)]})}},Ii=(e,t)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(r=>i.push(Number(r))),Z({axes:i,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},xe=(e,t,i,r)=>{let a=e.inputs,s=a.length===1?i:Ii(a,i);e.compute(Rt(t,{hint:s.cacheKey,inputDependencies:["rank"]},[a[0]],s.noopWithEmptyAxes&&s.axes.length===0?on:r,s.axes,a[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},un=(e,t)=>{ve(e.inputs),xe(e,"ReduceLogSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,"value = log(value);"])},ln=(e,t)=>{ve(e.inputs),xe(e,"ReduceL1",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${i.getByIndices("input_indices")});`,""])},dn=(e,t)=>{ve(e.inputs),xe(e,"ReduceL2",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},pn=(e,t)=>{ve(e.inputs),xe(e,"ReduceLogSumExp",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${i.getByIndices("input_indices")});`,"value = log(value);"])},hn=(e,t)=>{ve(e.inputs),xe(e,"ReduceMax",t,(i,r,a)=>{let s=[];for(let n=0;n<i.rank;n++)(a.indexOf(n)>=0||a.length===0)&&s.push(i.indicesSet("input_indices",n,0));return[`${s.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = max(value, ${i.getByIndices("input_indices")});`,""]})},cn=(e,t)=>{ve(e.inputs),xe(e,"ReduceMean",t,(i,r,a)=>{let s=1;for(let n=0;n<i.rank;n++)(a.indexOf(n)>=0||a.length===0)&&(s*=e.inputs[0].dims[n]);return["var sum = f32(0);","",`sum += f32(${i.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${s});`]})},fn=(e,t)=>{ve(e.inputs),xe(e,"ReduceMin",t,(i,r,a)=>{let s=[];for(let n=0;n<i.rank;n++)(a.indexOf(n)>=0||a.length===0)&&s.push(`input_indices[${n}] = 0;`);return[`${s.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = min(value, ${i.getByIndices("input_indices")});`,""]})},mn=(e,t)=>{ve(e.inputs),xe(e,"ReduceProd",t,(i,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${i.getByIndices("input_indices")};`,""])},gn=(e,t)=>{ve(e.inputs),xe(e,"ReduceSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,""])},_n=(e,t)=>{ve(e.inputs),xe(e,"ReduceSumSquare",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += t * t;`,""])},ke=(e,t,i)=>{if(t.length===0)return i;let r=1,a=1;for(let s=0;s<t.length;s++)t.indexOf(s)===-1?r*=e[s]:a*=e[s];return a<32&&r>1024},yn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?cn(e,t):Za(e,t)},$n=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?ln(e,t):Xa(e,t)},wn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?dn(e,t):Ya(e,t)},bn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?pn(e,t):Ja(e,t)},vn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?hn(e,t):en(e,t)},xn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?fn(e,t):tn(e,t)},kn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?mn(e,t):rn(e,t)},Sn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?gn(e,t):an(e,t)},In=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?_n(e,t):nn(e,t)},Tn=(e,t)=>{ke(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?un(e,t):sn(e,t)}}),zi,zn,En,Ei,fp=z(()=>{P(),te(),Ti(),zi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},zn=(e,t)=>{zi(e.inputs);let i=(r,a,s)=>{let n=[];for(let o=0;o<r.rank;o++)(s.indexOf(o)>=0||s.length===0)&&n.push(`input_indices[${o}] = 0;`);return[`${n.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?"<=":"<"} value) {
         value = ${r.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",a.setByOffset("global_idx","best_index")]};e.compute(Rt("ArgMin",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},En=(e,t)=>{zi(e.inputs);let i=(r,a,s)=>{let n=[];for(let o=0;o<r.rank;o++)(s.indexOf(o)>=0||s.length===0)&&n.push(`input_indices[${o}] = 0;`);return[`${n.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${r.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",a.setByOffset("global_idx","best_index")]};e.compute(Rt("argMax",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Ei=e=>Z(e)}),Cn,Dt,On,An,Bn,ht,Rn,Dn,Ci=z(()=>{P(),q(),$i(),L(),Cn=(e,t)=>{let i=e[0],r=e[1],a=e[2],s=e[3],n=e[4],o=e[5];if(n&&o)throw new Error("Attention cannot have both past and attention_bias");if(i.dims.length!==3)throw new Error('Input "input" must have 3 dimensions');let u=i.dims[0],l=i.dims[1],d=i.dims[2];if(a.dims.length!==1)throw new Error('Input "bias" is expected to have 1 dimensions');if(r.dims.length!==2)throw new Error('Input "weights" is expected to have 2 dimensions');if(r.dims[0]!==d)throw new Error("Input 1 dimension 0 should have same length as dimension 2 of input 0");if(a.dims[0]!==r.dims[1])throw new Error('Input "bias" dimension 0 should have same length as dimension 1 of input "weights"');let p=a.dims[0]/3,h=p,c=h;if(t.qkvHiddenSizes.length>0){if(t.qkvHiddenSizes.length!==3)throw new Error("qkv_hidden_sizes attribute should have 3 elements");for(let w of t.qkvHiddenSizes)if(w%t.numHeads!==0)throw new Error("qkv_hidden_sizes should be divisible by num_heads");p=t.qkvHiddenSizes[0],h=t.qkvHiddenSizes[1],c=t.qkvHiddenSizes[2]}let f=l;if(p!==h)throw new Error("qkv_hidden_sizes first element should be same as the second");if(a.dims[0]!==p+h+c)throw new Error('Input "bias" dimension 0 should have same length as sum of Q/K/V hidden sizes');let m=0;if(n){if(h!==c)throw new Error('Input "past" expect k_hidden_size == v_hidden_size');if(n.dims.length!==5)throw new Error('Input "past" must have 5 dimensions');if(n.dims[0]!==2)throw new Error('Input "past" first dimension must be 2');if(n.dims[1]!==u)throw new Error('Input "past" second dimension must be batch_size');if(n.dims[2]!==t.numHeads)throw new Error('Input "past" third dimension must be num_heads');if(n.dims[4]!==h/t.numHeads)throw new Error('Input "past" fifth dimension must be k_hidden_size / num_heads');t.pastPresentShareBuffer||(m=n.dims[3])}let y=f+m,_=-1,g=0;if(s)throw new Error("Mask not supported");if(n)throw new Error("past is not supported");if(o){if(o.dims.length!==4)throw new Error('Input "attention_bias" must have 4 dimensions');if(o.dims[0]!==u||o.dims[1]!==t.numHeads||o.dims[2]!==l||o.dims[3]!==y)throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)')}return{batchSize:u,sequenceLength:l,pastSequenceLength:m,kvSequenceLength:f,totalSequenceLength:y,maxSequenceLength:_,inputHiddenSize:d,hiddenSize:p,vHiddenSize:c,headSize:Math.floor(p/t.numHeads),vHeadSize:Math.floor(c/t.numHeads),numHeads:t.numHeads,isUnidirectional:!1,pastPresentShareBuffer:!1,maskFilterValue:t.maskFilterValue,maskType:g,scale:t.scale,broadcastResPosBias:!1,passPastInKv:!1,qkvFormat:1}},Dt=(e,t,i)=>t&&e?`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${n}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...D(s)]:[{type:12,data:u}]})}},Pn=e=>Z(e),Nn=(e,t)=>{let{inputs:i,outputCount:r}=e,a=Pn({...t,outputCount:r});if(Y.webgpu.validateInputContent&&Mn(i,a),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Un(i,a))}}),qn,Vn,Ln,gp=z(()=>{q(),L(),qn=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Vn=e=>{let t=e[0].dims,i=e[0].dims[2],r=k.size(t)/4,a=e[0].dataType,s=S("input",a,t,4),n=S("bias",a,[i],4),o=S("residual",a,t,4),u=B("output",a,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:l=>`
  ...
  }`}},Ln=e=>{qn(e.inputs),e.compute(Vn(e.inputs))}}),Gn,F,Wn,Hn,Fn,jn,Kn,Qn,Zn,Xn,Yn,Jn,es,ts,is,rs,ct,as,Mt,ns,ss,os,us,ls,ds,ps,hs,cs,fs,ms,gs,_s,ys,$s,ws,Oi,bs,Ai,Bi,vs,xs,ks,Ss,Is,Ts,Ri=z(()=>{P(),q(),te(),L(),Gn=(e,t,i,r,a,s,n)=>{let o=Math.ceil(t/4),u="";typeof a=="string"?u=`${a}(a)`:u=a("a");let l=S("inputData",i,[o],4),d=B("outputData",r,[o],4),p=[{name:"vec_size",type:"u32"}];return n&&p.push(...n),`
  ...
  }`},F=(e,t,i,r,a,s=e.dataType,n,o)=>{let u=[{type:12,data:Math.ceil(k.size(e.dims)/4)}];return n&&u.push(...n),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:l=>Gn(l,k.size(e.dims),e.dataType,s,i,r,o),getRunData:l=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(k.size(l[0].dims)/64/4)},programUniforms:u})}},Wn=e=>{e.compute(F(e.inputs[0],"Abs","abs"))},Hn=e=>{e.compute(F(e.inputs[0],"Acos","acos"))},Fn=e=>{e.compute(F(e.inputs[0],"Acosh","acosh"))},jn=e=>{e.compute(F(e.inputs[0],"Asin","asin"))},Kn=e=>{e.compute(F(e.inputs[0],"Asinh","asinh"))},Qn=e=>{e.compute(F(e.inputs[0],"Atan","atan"))},Zn=e=>{e.compute(F(e.inputs[0],"Atanh","atanh"))},Xn=e=>Z(e),Yn=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(F(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},Jn=e=>{let t,i,r=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,i=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,i=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Z({min:t,max:i})},es=(e,t)=>{let i=t||Jn(e.inputs),r=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},ts=e=>{e.compute(F(e.inputs[0],"Ceil","ceil"))},is=e=>{e.compute(F(e.inputs[0],"Cos","cos"))},rs=e=>{e.compute(F(e.inputs[0],"Cosh","cosh"))},ct=e=>Z(e),as=(e,t)=>{let i=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,ns=e=>{let t=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Mt(t)))},ss=e=>{e.compute(F(e.inputs[0],"Exp","exp"))},os=e=>{e.compute(F(e.inputs[0],"Floor","floor"))},us=e=>{let t=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Mt(t)))},ls=(e,t)=>{let i=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},ds=e=>{e.compute(F(e.inputs[0],"Not",t=>`!${t}`))},ps=e=>{e.compute(F(e.inputs[0],"Neg",t=>`-${t}`))},hs=e=>{e.compute(F(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},cs=e=>{let t=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},fs=e=>{e.compute(F(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},ms=e=>Z(e),gs=(e,t)=>{let i=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},_s=e=>{e.compute(F(e.inputs[0],"Sin","sin"))},ys=e=>{e.compute(F(e.inputs[0],"Sinh","sinh"))},$s=e=>{e.compute(F(e.inputs[0],"Sqrt","sqrt"))},ws=e=>{e.compute(F(e.inputs[0],"Tan","tan"))},Oi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,bs=e=>{e.compute(F(e.inputs[0],"Tanh",Oi))},Ai=(e="f32")=>`
...
`,Bi=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,vs=e=>{let t=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"FastGelu",Bi,Ai(t),void 0,e.inputs[0].dataType))},xs=(e,t)=>{let i=ue(e.inputs[0].dataType);return e.compute(F(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${i}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},ks=e=>{e.compute(F(e.inputs[0],"Log","log"))},Ss=(e,t)=>`
...
`,Is=e=>`quick_gelu_impl(${e})`,Ts=(e,t)=>{let i=ue(e.inputs[0].dataType);e.compute(F(e.inputs[0],"QuickGelu",Is,Ss(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),zs,Es,Cs,_p=z(()=>{q(),L(),Ri(),zs=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Es=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),a=B("output",e[0].dataType,t,4),s=k.size(t)/4,n=ae(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:o=>`
  ...
  ${o.mainStart()}
    ...
    ${a.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${_}
      }`},As=(e,t,i,r,a,s,n=i.dataType)=>{let o=i.dims.map(m=>Number(m)??1),u=r.dims.map(m=>Number(m)??1),l=!k.areEqual(o,u),d=o,p=k.size(o),h=!1,c=!1,f=[l];if(l){let m=Je.calcShape(o,u,!1);if(!m)throw new Error("Can't perform binary op on the given tensors");d=m.slice(),p=k.size(d);let y=k.size(o)===1,_=k.size(u)===1,g=o.length>0&&o[o.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;f.push(y),f.push(_),f.push(g),f.push(w);let $=1;for(let b=1;b<d.length;b++){let v=o[o.length-b],x=u[u.length-b];if(v===x)$*=v;else break}$%4===0?(c=!0,h=!0):(y||_||g||w)&&(h=!0)}else h=!0;return f.push(h),{name:e,shaderCache:{hint:t+f.map(m=>m.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:m=>Os(m,o,u,d,h,l,c,a,i.dataType,r.dataType,n,s),getRunData:()=>({outputs:[{dims:d,dataType:n}],dispatchGroup:{x:Math.ceil(p/64/4)},programUniforms:[{type:12,data:Math.ceil(k.size(d)/4)},...D(o,u,d)]})}},Se=(e,t,i,r,a,s)=>{e.compute(As(t,a??"",e.inputs[0],e.inputs[1],i,r,s))},Bs=e=>{Se(e,"Add",(t,i)=>`${t}+${i}`)},Rs=e=>{Se(e,"Div",(t,i)=>`${t}/${i}`)},Ds=e=>{Se(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Ms=e=>{Se(e,"Mul",(t,i)=>`${t}*${i}`)},Us=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Se(e,"Pow",{scalar:(i,r)=>`pow_custom(${i},${r})`,vector:(i,r)=>`pow_vector_custom(${i},${r})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Ps=e=>{Se(e,"Sub",(t,i)=>`${t}-${i}`)},Ns=e=>{Se(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},qs=e=>{Se(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},Vs=e=>{Se(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},Ls=e=>{Se(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),Gs,Ws,Hs,Fs,js,Ks,$p=z(()=>{P(),q(),te(),L(),Gs=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,r=e[i],a=r.dataType,s=r.dims.length;e.forEach((n,o)=>{if(o!==i){if(n.dataType!==a)throw new Error("input tensors should be one type");if(n.dims.length!==s)throw new Error("input tensors should have the same shape");n.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},Ws=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,Hs=(e,t)=>{let i=e.length,r=[];for(let a=0;a<i;++a){let s=t.setByOffset("global_idx",e[a].getByIndices("indices"));i===1?r.push(s):a===0?r.push(`if (inputIndex == ${a}u) { ${s} }`):a===i-1?r.push(`else { ${s} }`):r.push(`else if (inputIndex == ${a}) { ${s} }`)}return r.join(`
`)},Fs=(e,t,i,r)=>{let a=k.size(i),s=new Array(e.length),n=new Array(e.length),o=0,u=[],l=[],d=[{type:12,data:a}];for(let m=0;m<e.length;++m)o+=e[m].dims[t],s[m]=o,l.push(e[m].dims.length),n[m]=S(`input${m}`,r,l[m]),u.push("rank"),d.push({type:12,data:s[m]});for(let m=0;m<e.length;++m)d.push(...D(e[m].dims));d.push(...D(i));let p=B("output",r,i.length),h=p.indicesGet("indices",t),c=Array.from(Array(s.length).keys()).map(m=>`uniforms.sizeInConcatAxis${m}`).join(","),f=m=>`
  ...
  ${m.mainStart()}
    ...
    ${Hs(n,p)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:f}},js=(e,t)=>{let i=e.inputs,r=i[0].dims,a=k.normalizeAxis(t.axis,r.length);Gs(i,a);let s=r.slice();s[a]=i.reduce((o,u)=>o+(u.dims.length>a?u.dims[a]:0),0);let n=i.filter(o=>k.size(o.dims)>0);e.compute(Fs(n,a,s,i[0].dataType),{inputs:n})},Ks=e=>Z({axis:e.axis})}),Le,Ge,We,Di,He=z(()=>{P(),q(),Le=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Ge=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},We=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Di=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[i,r]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=(e==null?void 0:e.activation_params)||[za,Ea];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:i}}return{activation:t}}}),ne,Qs,Mi=z(()=>{ne=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Qs=e=>`
...
`}),ft,Ui,Pi=z(()=>{P(),q(),L(),He(),ft=(e,t,i,r,a)=>{let s=r-i;return`
...
`},Ui=(e,t,i,r,a=!1,s)=>{let n=e[0].dims,o=e[1].dims,u=n[n.length-2],l=o[o.length-1],d=n[n.length-1],p=ee(l),h=ee(d),c=ee(u),f=k.size(i)/p/c,m=e.length>2,y=r?r.slice(0,-2):i.slice(0,-2),_=[k.size(y),u,l],g=[{type:12,data:f},{type:12,data:u},{type:12,data:l},{type:12,data:d}];Ge(t,g),g.push(...D(y,n,o)),m&&g.push(...D(e[2].dims)),g.push(...D(_));let w=$=>{let b=ki("batch_dims",e[0].dataType,y.length),v=S("a",e[0].dataType,n.length,h),x=S("b",e[1].dataType,o.length,p),I=B("output",e[0].dataType,_.length,p),E=ae(I.type.tensor),A=Le(t,I.type.value,E),N=[v,x],G="";if(m){let W=a?p:1;N.push(S("bias",e[2].dataType,e[2].dims.length,W)),G=`${a?`value += bias[col / ${W}];`:`value += ${I.type.value}(bias[row + i]);`}`}let U=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];We(t,U);let V=()=>{let W=`var a_data: ${v.type.value};`;for(let O=0;O<h;O++)W+=`
...
`}return W};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${h};${c};${a}`,inputDependencies:m?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:g}),getShaderSource:w}}}),Xs,Ys,Ni,qi,Js,Vi,eo,Ut,Li=z(()=>{P(),q(),L(),He(),Pi(),Mi(),Xs=(e,t)=>e?`
        ...
        }`,Ni=(e,t,i="f32",r,a=!1,s=32,n=!1,o=32)=>{let u=t[1]*e[1],l=t[0]*e[0],d=a?u:s,p=a?s:u,h=d/t[0],c=s/t[1];if(!((a&&h===4&&e[1]===4||!a&&(h===3||h===4))&&d%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${a} is true, innerElementSize ${h} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,Js=e=>e?"let ACached = mm_Asub[k][tileRow + innerRow];":"let ACached = mm_Asub[tileRow + innerRow][k];",Vi=(e,t,i="f32",r,a=!1,s=32,n=!1,o=32,u=!1)=>{let l=e[1]*t[1],d=e[0]*t[0],p=a?l:s,h=a?s:l;if(!(h%t[1]===0&&p%t[0]===0&&s%t[1]===0))throw new Error(`tileAHight ${h} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${p} must be divisible by workgroupSize[0]${t[0]}, tileInner ${s} must be divisible by workgroupSize[1]${t[1]}`);let c=h/t[1],f=p/t[0],m=s/t[1],y=u?`
    let localRow = i32(localId.y);
...
`},eo=(e,t,i,r,a=!1)=>{let[s,n,o,u]=r,l=ae(r[0].type.tensor);return`
  ...
  ${m?Ni(y,_,O,W):Vi(y,_,O,W)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${b}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${m?`vec4<${M}>`:M}) {
        ...
        ${X}
        ${to(l,E,A,N,n,t,G[0],G[1],G[2],M)}
        ${m?Ni(w,g,M,void 0,!l,I):Vi(w,g,M,void 0,!l,I,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${b};${m};${E};${A};${N};${v};${x};${I}`,inputDependencies:V},getRunData:()=>({outputs:[{dims:u?u(i):i,dataType:e[0].dataType}],dispatchGroup:{x:$[0],y:$[1],z:$[2]},programUniforms:U}),getShaderSource:W}}}),ro,Gi,mt,ao,Wi,no,so,oo,vp=z(()=>{P(),ze(),q(),L(),He(),Mi(),ro=e=>{let t=1;for(let i=0;i<e.length;i++)t*=e[i];return t},Gi=e=>typeof e=="number"?[e,e,e]:e,mt=(e,t)=>t<=1?e:e+(e-1)*(t-1),ao=(e,t,i,r=1)=>{let a=mt(t,r);return Math.floor((e[0]*(i-1)-i+a)/2)},Wi=(e,t,i,r,a)=>{a==null&&(a=ao(e,t[0],r[0]));let s=[0,0,0,i];for(let n=0;n<3;n++)e[n]+2*a>=t[n]&&(s[n]=Math.trunc((e[n]-t[n]+2*a)/r[n]+1));return s},no=(e,t,i,r,a,s,n,o,u,l)=>{let d,p,h,c;if(e==="VALID"&&(e=0),typeof e=="number"){d={top:e,bottom:e,left:e,right:e,front:e,back:e};let f=Wi([t,i,r,1],[o,u,l],1,[a,s,n],e);p=f[0],h=f[1],c=f[2]}else if(Array.isArray(e)){if(!e.every((m,y,_)=>m===_[0]))throw Error(`Unsupported padding parameter: ${e}`);d={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let f=Wi([t,i,r,1],[o,u,l],1,[a,s,n],e[0]);p=f[0],h=f[1],c=f[2]}else if(e==="SAME_UPPER"){p=Math.ceil(t/a),h=Math.ceil(i/s),c=Math.ceil(r/n);let f=(p-1)*a+o-t,m=(h-1)*s+u-i,y=(c-1)*n+l-r,_=Math.floor(f/2),g=f-_,w=Math.floor(m/2),$=m-w,b=Math.floor(y/2),v=y-b;d={top:w,bottom:$,left:b,right:v,front:_,back:g}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:d,outDepth:p,outHeight:h,outWidth:c}},so=(e,t,i,r,a,s=!1,n="channelsLast")=>{let o,u,l,d,p;if(n==="channelsLast")[o,u,l,d,p]=e;else if(n==="channelsFirst")[o,p,u,l,d]=e;else throw new Error(`Unknown dataFormat ${n}`);let[h,,c,f,m]=t,[y,_,g]=Gi(i),[w,$,b]=Gi(r),v=mt(c,w),x=mt(f,$),I=mt(m,b),{padInfo:E,outDepth:A,outHeight:N,outWidth:G}=no(a,u,l,d,y,_,g,v,x,I),U=s?h*p:h,V=[0,0,0,0,0];return n==="channelsFirst"?V=[o,U,A,N,G]:n==="channelsLast"&&(V=[o,A,N,G,U]),{batchSize:o,dataFormat:n,inDepth:u,inHeight:l,inWidth:d,inChannels:p,outDepth:A,outHeight:N,outWidth:G,outChannels:U,padInfo:E,strideDepth:y,strideHeight:_,strideWidth:g,filterDepth:c,filterHeight:f,filterWidth:m,effectiveFilterDepth:v,effectiveFilterHeight:x,effectiveFilterWidth:I,dilationDepth:w,dilationHeight:$,dilationWidth:b,inShape:e,outShape:V,filterShape:t}},oo=(e,t,i,r,a,s)=>{let n=s==="channelsLast";n?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:i.map((y,_)=>_)},l=[Math.ceil(ro(u.x.map(y=>i[y]))/o[0]),1,1];H("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let d=1,p=k.size(i),h=[{type:12,data:p},{type:12,data:r},{type:12,data:a},{type:12,data:t.strides},{type:12,data:t.dilations}];Ge(t,h),h.push(...D(e[0].dims,e[1].dims));let c=["rank","rank"],f=e.length===3;f&&(h.push(...D(e[2].dims)),c.push("rank")),h.push(...D(i));let m=y=>{let _=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:r.length},{name:"pads",type:"u32",length:a.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];We(t,_);let g=1,w=ae(e[0].dataType),$=S("x",e[0].dataType,e[0].dims.length,d),b=S("W",e[1].dataType,e[1].dims.length,g),v=[$,b],x=B("result",e[0].dataType,i.length,g),I="";if(f){let N=S("bias",e[2].dataType,e[2].dims.length,g);v.push(N),I+=`
  ...
  ${f.mainStart()}
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${s};${n};${h};${l[0]};${l[1]}`,inputDependencies:a?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p}),getShaderSource:c}}}),po,Pt,ho,Nt,Hi,Fi,co,fo,ji,kp=z(()=>{q(),bp(),vp(),Li(),xp(),He(),Pi(),Ae(),po=(e,t,i,r,a,s)=>{let n=e[0],o=e.slice(s?1:2,s?3:4),u=o.length,l=t[0],d=t.slice(2).map((h,c)=>h+(h-1)*(i[c]-1)),p=o.map((h,c)=>h+r[c]+r[c+u]).map((h,c)=>Math.floor((h-d[c]+a[c])/a[c]));return p.splice(0,0,n),p.splice(s?3:1,0,l),p},Pt=[2,3,1,0],ho=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Nt=(e,t)=>{let i=e.kernelShape.slice();i.length<t[1].dims.length-2&&i.push(...Array(t[1].dims.length-2-i.length).fill(0));for(let s=2;s<t[1].dims.length;++s)i[s-2]===0&&(i[s-2]=t[1].dims[s]);let r=e.pads.slice();At.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,i,r,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:i,pads:r}),a},Hi=e=>{let t=Di(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,s=e.group,n=e.kernel_shape,o=e.pads,u=e.strides,l=e.w_is_const();return{autoPad:r,format:i,dilations:a,group:s,kernelShape:n,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Fi=(e,t,i,r)=>{let a=i.format==="NHWC",s=po(t[0].dims,t[1].dims,i.dilations,i.pads,i.strides,a);if(i.group!==1){let v=[t[0]];if(a){let x=e.kernelCustomData.wT??e.compute(fe(t[1],Pt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=x),v.push(x)}else v.push(t[1]);t.length===3&&v.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&a&&t[1].dims[0]===i.group&&t[1].dims[1]===1&&i.dilations[0]===1&&i.dilations[1]===1?e.compute(lo(v,i,s,r),{inputs:v}):e.compute(uo(v,i,s,r),{inputs:v});return}let n=t.length===3,o=t[0].dims[a?1:2],u=t[0].dims[a?2:3],l=t[0].dims[a?3:1],d=t[1].dims[2],p=t[1].dims[3],h=s[a?1:2],c=s[a?2:3],f=s[a?3:1],m=a&&d===o&&p===u&&i.pads[0]===0&&i.pads[1]===0;if(m||d===1&&p===1&&i.dilations[0]===1&&i.dilations[1]===1&&i.strides[0]===1&&i.strides[1]===1&&i.pads[0]===0&&i.pads[1]===0){let v=s[0],x,I,E,A=[];if(a){let U=e.kernelCustomData.wT??e.compute(fe(t[1],Pt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];if(i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=U),m){let V=o*u*l;x=t[0].reshape([1,v,V]),I=U.reshape([1,V,f]),E=[1,v,f]}else x=t[0].reshape([v,o*u,l]),I=U.reshape([1,l,f]),E=[v,h*c,f];A.push(x),A.push(I)}else x=t[0].reshape([v,l,o*u]),I=t[1].reshape([1,f,l]),E=[v,f,h*c],A.push(I),A.push(x);n&&A.push(t[2]);let N=E[2],G=A[0].dims[A[0].dims.length-1];N<8&&G<8?e.compute(Ui(A,i,s,E,a,r),{inputs:A}):e.compute(Ut(A,i,s,E,a,r),{inputs:A});return}let y=!0,_=e.kernelCustomData.wT??e.compute(fe(t[1],Pt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=_);let g=[t[0],_];n&&g.push(t[2]);let w=a?h*c:f,$=a?f:h*c,b=d*p*l;e.compute(io(g,i,s,w,$,b,n,y,r),{inputs:g})},co=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),n=[1].concat(t.dilations),o=[1].concat(t.kernelShape),u=Nt({...t,pads:a,strides:s,dilations:n,kernelShape:o},r);Fi(e,r,u,l=>i?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},fo=(e,t,i)=>{let r=i.format==="NHWC"?"channelsLast":"channelsFirst",a=Nt(i,t),s=i.autoPad==="NOTSET"?i.pads:i.autoPad,n=so(t[0].dims,t[1].dims,i.strides,i.dilations,s,!1,r);e.compute(oo(t,a,n.outShape,[n.filterDepth,n.filterHeight,n.filterWidth],[n.padInfo.front,n.padInfo.top,n.padInfo.left],r))},ji=(e,t)=>{if(ho(e.inputs,t),e.inputs[0].dims.length===3)co(e,t);else if(e.inputs[0].dims.length===5)fo(e,e.inputs,t);else{let i=Nt(t,e.inputs);Fi(e,e.inputs,i)}}}),mo,Sp=z(()=>{P(),ze(),q(),L(),mo=(e,t,i)=>{let r=e.length>2,a=t.outputShape,s=t.format==="NHWC",n=t.group,o=e[1].dims,u=o[2]/n,l=o[3],d=s?ee(u):1,p=s?ee(l):1,h=s?l===1?d:p:1,c=k.size(a)/p,f=[Math.ceil(c/64),1,1];H("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${f}`);let m=["rank","rank"],y=[t.strides[0],t.strides[1]],_=[t.kernelShape[s?1:2],t.kernelShape[s?2:3]],g=[t.dilations[0],t.dilations[1]],w=[_[0]+(t.dilations[0]<=1?0:(t.kernelShape[s?1:2]-1)*(t.dilations[0]-1)),_[1]+(t.dilations[1]<=1?0:(t.kernelShape[s?2:3]-1)*(t.dilations[1]-1))],$=[w[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),w[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],b=[{type:12,data:c},{type:12,data:y},{type:12,data:_},{type:12,data:g},{type:12,data:w},{type:6,data:$},{type:12,data:u},{type:12,data:l},...D(e[0].dims,e[1].dims)];r&&(b.push(...D(e[2].dims)),m.push("rank")),b.push(...D(a));let v=x=>{let I=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:y.length},{name:"filter_dims",type:"u32",length:_.length},{name:"dilations",type:"u32",length:_.length},{name:"effective_filter_dims",type:"u32",length:w.length},{name:"pads",type:"i32",length:$.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],E=ae(e[0].dataType),A=s?1:2,N=s?2:3,G=s?3:1,U=S("W",e[1].dataType,e[1].dims.length,h),V=S("Dy",e[0].dataType,e[0].dims.length,d),W=[V,U];r&&W.push(S("bias",e[2].dataType,[a[G]].length,p));let O=B("result",e[0].dataType,a.length,p),j=()=>{let M="";if(d===1)M+=`
    ...
    ${J}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${d}${h}${p}${l===1}`,inputDependencies:m},getRunData:()=>({dispatchGroup:{x:f[0],y:f[1],z:f[2]},outputs:[{dims:i?i(a):a,dataType:e[0].dataType}],programUniforms:b}),getShaderSource:v}}}),go,_o,yo,Ki,$o,wo,Qi,bo,vo,Ip=z(()=>{Sp(),He(),Ae(),go=(e,t,i,r,a,s)=>(e-1)*t+i+(r-1)*a+1-s,_o=(e,t,i,r,a)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(i[r]=s,i[a]=e-s):t==="SAME_LOWER"&&(i[r]=e-s,i[a]=s)},yo=(e,t,i,r,a,s,n,o,u,l)=>{let d=e.length-2,p=l.length===0;u.length<d&&u.push(...Array(d-u.length).fill(0));let h=e[0],c=t[o?3:1]*a;for(let f=0,m=e.length-d-(o?1:0);f<d;++f,++m){let y=e[m],_=p?y*n[f]:l[f],g=go(y,n[f],s[f],t[m],i[f],_);_o(g,r,s,f,f+d),p&&l.push(n[f]*(y-1)+u[f]+(t[m]-1)*i[f]+1-s[f]-s[f+d])}l.splice(0,0,h),l.splice(o?3:1,0,c)},Ki=(e,t)=>{let i=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((p,h)=>p*h,1)===0){i.length=0;for(let p=2;p<t[1].dims.length;++p)i.push(t[1].dims[p])}let r=e.format==="NHWC";i.splice(0,0,t[1].dims[0]),i.splice(r?3:1,0,t[1].dims[1]);let a=e.pads.slice(),s=e.outputShape.slice(),n=e.outputPadding.slice(),o=t[0].dims,u=e.dilations.slice();if(u.reduce((p,h)=>p+h,0)===0){let p=t[0].dims.length-2;u=new Array(p).fill(1)}let l=e.strides.slice();if(l.reduce((p,h)=>p+h,0)===0){let p=t[0].dims.length-2;l=new Array(p).fill(1)}yo(o,i,u,e.autoPad,e.group,a,l,r,n,s);let d=Object.assign({},e);return Object.assign(d,{kernelShape:i,pads:a,outputPadding:n,outputShape:s,dilations:u,strides:l}),d},$o=e=>{let t=Di(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],a=e.dilations,s=e.group,n=e.kernelShape,o=e.pads,u=e.strides,l=e.wIsConst(),d=e.outputPadding,p=e.outputShape;return{autoPad:r,format:i,dilations:a,group:s,kernelShape:n,outputPadding:d,outputShape:p,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},wo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let a=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==a))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((n,o)=>n+o,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((n,o)=>n+o,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((n,o)=>n+o,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((n,o)=>n+o,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Qi=(e,t,i,r)=>{let a=e.kernelCustomData.wT??e.compute(fe(t[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a);let s=[t[0],a];t.length===3&&s.push(t[2]),e.compute(mo(s,i,r),{inputs:s})},bo=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let a=t.kernelShape;(a.length===0||a[0]===0)&&(a=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let n=t.strides;(n.length===0||n[0]===0)&&(n=[1]);let o=t.pads;o.length===0&&(o=[0,0]),o=[0,o[0],0,o[1]],n=[1].concat(n),s=[1].concat(s),a=[1].concat(a);let u=t.outputPadding;u=[0].concat(u);let l=Ki({...t,pads:o,strides:n,dilations:s,kernelShape:a,outputPadding:u},r);Qi(e,r,l,d=>i?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},vo=(e,t)=>{if(wo(e.inputs,t),e.inputs[0].dims.length===3)bo(e,t);else{let i=Ki(t,e.inputs);Qi(e,e.inputs,i)}}}),xo,ko,So,Tp=z(()=>{P(),q(),te(),L(),xo=(e,t,i,r)=>{let a=k.size(t),s=t.length,n=S("input",e,s),o=B("output",e,s),u=i.dataType===6?i.getInt32Array()[0]:Number(i.getBigInt64Array()[0]),l=k.normalizeAxis(u,s),d=p=>{let h=` i32(${n.indicesGet("inputIndices","uniforms.axis")}) `,c=R("uniforms.input_shape","uniforms.axis",s),f=r.reverse?h+(r.exclusive?" + 1":""):"0",m=r.reverse?c:h+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},{type:12,data:l},...D(t,t)]}),getShaderSource:d}},ko=(e,t)=>{let i=e.inputs[0].dims,r=e.inputs[0].dataType,a=e.inputs[1];e.compute(xo(r,i,a,t),{inputs:[0]})},So=e=>{let t=e.exclusive===1,i=e.reverse===1;return Z({exclusive:t,reverse:i})}}),Io,To,zo,Eo,Co,zp=z(()=>{P(),q(),te(),L(),Io=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},To=(e,t,i,r)=>{let a=[];a.push(`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
...
`)},zo=(e,t)=>{let i,r,a,s,n,o,u=t.format==="NHWC",l=t.blocksize,d=t.mode==="DCR";u?([i,r,a,s]=e.dims,n=d?[i,r,a,l,l,s/l**2]:[i,r,a,s/l**2,l,l],o=d?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([i,r,a,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],n=d?[i,l,l,s/l**2,r,a]:[i,s/l**2,l,l,r,a],o=d?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let p=e.reshape(n),h=p.dims.length,c=e.dataType,f=S("a",c,h),m=B("output",c,h),y=_=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:_=>{let g=u?[i,r*l,a*l,s/l**2]:[i,s/l**2,r*l,a*l],w=k.size(g),$=p.dims,b=k.sortBasedOnPerm($,o);return{outputs:[{dims:g,dataType:_[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...D($,b)]}},getShaderSource:y}},Eo=(e,t)=>{Io(e.inputs),e.compute(zo(e.inputs[0],t))},Co=e=>Z({blocksize:e.blocksize,mode:e.mode,format:e.format})}),qt,gt,Zi,Oo,Ao,Bo,Ro,Xi,Do,Mo,Uo,Ep=z(()=>{P(),q(),te(),L(),qt="[a-zA-Z]|\\.\\.\\.",gt="("+qt+")+",Zi="^"+gt+"$",Oo="("+gt+",)*"+gt,Ao="^"+Oo+"$",Bo=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let i=this.symbolToIndices.get(e);i===void 0?i=[t]:i.push(t),this.symbolToIndices.set(e,i)}},Ro=class{constructor(e,t){var a;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[i,r]=t.includes("->")?t.split("->",2):[t,""];if(!i.match(RegExp(Ao)))throw new Error("Invalid LHS term");if(i.split(",").forEach((s,n)=>{let o=e[n].dims.slice();if(!s.match(RegExp(Zi)))throw new Error("Invalid LHS term");let u=this.processTerm(s,!0,o,n);this.lhs.push(u)}),r==="")r+=[...this.symbolToInfo.entries()].filter(([s,n])=>n.count===1||s==="...").map(([s])=>s).join("");else if(!r.match(RegExp(gt)))throw new Error("Invalid RHS");(a=r.match(RegExp(qt,"g")))==null||a.forEach(s=>{if(s==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let n=this.symbolToInfo.get(s);if(n===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(n.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,i){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw new Error("Dimension mismatch");r.count++,r.inputIndices.push(i)}else r={count:1,dimValue:t,inputIndices:[i]};this.symbolToInfo.set(e,r)}processTerm(e,t,i,r=-1){let a=i.length,s=!1,n=[],o=0;if(!e.match(RegExp(Zi))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(qt,"g")),l=new Bo(r);return u==null||u.forEach((d,p)=>{if(d==="..."){if(s)throw new Error("Only one ellipsis is allowed per input term");s=!0;let h=a-u.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(n=i.slice(o,o+h),this.hasEllipsis){if(this.ellipsisDims.length!==n.length||this.ellipsisDims.toString()!==n.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=n;else throw new Error("Ellipsis must be specified in the LHS");for(let c=0;c<n.length;c++){let f=String.fromCharCode(48+c);l.addSymbol(f,p+c),this.addSymbol(f,i[o++],r)}}else l.addSymbol(d,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(d,i[o++],r)}),l}},Xi=e=>e+"_max",Do=(e,t,i,r)=>{let a=e.map(l=>l.length).map((l,d)=>S(`input${d}`,t,l)),s=k.size(r),n=B("output",t,r.length),o=[...i.symbolToInfo.keys()].filter(l=>!i.rhs.symbolToIndices.has(l)),u=l=>{let d=[],p="var prod = 1.0;",h="var sum = 0.0;",c="sum += prod;",f=[],m=[],y=[],_=[],g=i.symbolToInfo.size===i.rhs.symbolToIndices.size;i.symbolToInfo.forEach(($,b)=>{var v;if(i.rhs.symbolToIndices.has(b)){let x=(v=i.rhs.symbolToIndices.get(b))==null?void 0:v[0];x!==void 0&&i.lhs.forEach((I,E)=>{if($.inputIndices.includes(E)){let A=I.symbolToIndices.get(b);if(A===void 0)throw new Error("Invalid symbol error");A.forEach(N=>{d.push(`${a[E].indicesSet(`input${E}Indices`,N,n.indicesGet("outputIndices",x))}`)})}})}else i.lhs.forEach((x,I)=>{if($.inputIndices.includes(I)){let E=x.symbolToIndices.get(b);if(E===void 0)throw new Error("Invalid symbol error");E.forEach(A=>{f.push(`${a[I].indicesSet(`input${I}Indices`,A,`${b}`)}`)}),_.push(`prod *= ${a[I].getByIndices(`input${I}Indices`)};`)}}),m.push(`for(var ${b}: u32 = 0; ${b} < uniforms.${Xi(b)}; ${b}++) {`),y.push("}")});let w=g?[...d,`let sum = ${a.map(($,b)=>$.getByIndices(`input${b}Indices`)).join(" * ")};`]:[...d,h,...m,...f,p,..._,c,...y];return`
            ${l.registerUniforms(o.map($=>({name:`${Xi($)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...a,n)}
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:i.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=o.filter(p=>i.symbolToInfo.has(p)).map(p=>{var h;return{type:12,data:((h=i.symbolToInfo.get(p))==null?void 0:h.dimValue)||0}});l.push({type:12,data:s});let d=e.map((p,h)=>[...D(p)]).reduce((p,h)=>p.concat(h),l);return d.push(...D(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}},getShaderSource:u}},Mo=(e,t)=>{let i=new Ro(e.inputs,t.equation),r=i.outputDims,a=e.inputs.map((s,n)=>s.dims);e.compute(Do(a,e.inputs[0].dataType,i,r))},Uo=e=>{let t=e.equation.replace(/\s+/g,"");return Z({equation:t})}}),Po,Yi,No,qo,Vo,Cp=z(()=>{P(),q(),L(),Po=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),r=i.length<t.length?0:i.length-t.length,a=t.length<i.length?0:t.length-i.length;for(;r<i.length&&a<t.length;++r,++a)if(i[r]!==t[a]&&i[r]!==1&&t[a]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Yi=(e,t)=>{let i=e.length-t.length,r=[];for(let a=0;a<i;++a)r.push(e[a]);for(let a=0;a<t.length;++a)r.push(t[a]===1?e[a+i]:t[a]);return r},No=(e,t)=>e.length>t.length?Yi(e,t):Yi(t,e),qo=e=>{let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),r=No(t,i),a=e[0].dataType,s=a===9||k.size(t)===1,n=a===9||t.length>0&&t[t.length-1]%4===0?4:1,o=s||r.length>0&&r[r.length-1]%4===0?4:1,u=Math.ceil(k.size(r)/o),l=p=>{let h=S("input",a,t.length,n),c=B("output",a,r.length,o),f;if(a===9){let m=(y,_,g="")=>`
    ...
    ${f}`},d=[{type:12,data:u},...D(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${n}${o}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},Vo=e=>{Po(e.inputs),e.compute(qo(e.inputs),{inputs:[0]})}}),Lo,Go,Op=z(()=>{P(),q(),L(),Ri(),Lo=e=>{let t=e[0].dataType,i=k.size(e[0].dims),r=k.size(e[1].dims),a=r%4===0,s=n=>{let o=S("x",t,[1],4),u=S("bias",t,[1],4),l=B("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=c=>`
    ...
    ${n.mainStart(et)}
      ...
      ${h}
      let x_in = x + bias;
      ${l.setByOffset("global_idx",Bi("x_in"))}
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${a}`,inputDependencies:["type","type"]},getShaderSource:s,getRunData:n=>({outputs:[{dims:n[0].dims,dataType:n[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(i/et/4)}})}},Go=e=>{e.inputs.length<2||k.size(e.inputs[1].dims)===0?vs(e):e.compute(Lo(e.inputs))}}),Wo,Ho,Fo,jo,Ap=z(()=>{P(),q(),te(),L(),Wo=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Ho=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i.length,s=k.normalizeAxis(t.axis,a),n=i.slice(0);n.splice(s,1,...r);let o=i[s],u=e[0].dataType===9?4:1,l=Math.ceil(k.size(n)/u),d=[{type:12,data:l},{type:6,data:o},{type:12,data:s},...D(e[0].dims,e[1].dims,n)],p=h=>{let c=S("data",e[0].dataType,e[0].dims.length,u),f=S("inputIndices",e[1].dataType,e[1].dims.length),m=B("output",e[0].dataType,n.length,u),y=g=>{let w=r.length,$=`var indicesIndices${g}  = ${f.type.indices}(0);`;for(let b=0;b<w;b++)$+=`${w>1?`indicesIndices${g}[${b}]`:`indicesIndices${g}`} = ${n.length>1?`outputIndices${g}[uniforms.axis + ${b}]`:`outputIndices${g}`};`;$+=`
  ...
  ${h.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((c,f)=>f!==1).map(c=>c.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(c,f)=>"rank")},getRunData:()=>({outputs:[{dims:o,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},Jo=(e,t)=>{let i=e.inputs;Xo(i,t),e.compute(Yo(e.inputs,t))},eu=e=>Z({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),tu,iu,ru,au,Dp=z(()=>{P(),q(),te(),L(),tu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},iu=(e,t)=>{let i=e[0].dims,r=e[0].dataType,a=i.length,s=e[1].dims,n=e[1].dataType,o=k.normalizeAxis(t.axis,a),u=i[o],l=s.slice(0),d=k.size(l),p=S("input",r,a),h=S("indicesInput",n,s.length),c=B("output",r,l.length),f=[{type:12,data:d},{type:6,data:u},{type:12,data:o}];return f.push(...D(i,s,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:m=>`
  ...
  }`};return p?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:c}),getShaderSource:y}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:c}),getShaderSource:m}},ou=e=>{let t=e.transA,i=e.transB,r=e.alpha,a=e.beta;return{transA:t,transB:i,alpha:r,beta:a,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},uu=(e,t)=>{nu(e.inputs),e.compute(su(e.inputs,t))}}),Ie,Ee,Fe,je,lu,du,pu,hu,cu,fu,mu,gu,_u,yu,Up=z(()=>{P(),q(),te(),L(),[Ie,Ee,Fe,je]=[0,1,2,3],lu=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},du=`
...
`,mu=(e,t,i)=>(()=>{switch(i.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[t,i],outputs:[-1]})[0]},_t=(e,t,i,r,a,s,n,o)=>{let u=s;if(n&&k.size(n.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=bu(e,s,n,t,r,i*a,o),u=u.reshape([t,r,i,a]),i===1||r===1?u:e.compute(fe(u,Ji.perm),{inputs:[u],outputs:[-1]})[0]}else return s.dims.length===3&&(u=s.reshape([t,r,i,a])),i===1||r===1?u:e.compute(fe(u,Ji.perm),{inputs:[u],outputs:[-1]})[0]},vu=(e,t)=>{let i=$u(e.inputs,t),r=e.inputs[0],a=de(e.inputs,1),s=de(e.inputs,2),n=de(e.inputs,3),o=de(e.inputs,4),u=de(e.inputs,5),l=de(e.inputs,6),d=de(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if((a==null?void 0:a.dims.length)===5)throw new Error("Packed KV is not implemented");let p=a&&s&&a.dims.length===4&&s.dims.length===4,h=_t(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r,n,0);if(p)return ht(e,h,a,s,o,void 0,l,d,u,i);if(!a||!s)throw new Error("key and value must be provided");let c=_t(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,a,n,i.hiddenSize),f=_t(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,s,n,2*i.hiddenSize);ht(e,h,c,f,o,void 0,l,d,u,i)}}),ku,Su,Iu,Tu,er,zu,Eu,Cu=z(()=>{P(),q(),te(),L(),ku=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Su=(e,t)=>{let i=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>i.push(Number(a))),r=i.length),Z({numOutputs:r,axis:t.axis,splitSizes:i})},Iu=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
}`,Tu=e=>{let t=e.length,i=[];for(let r=0;r<t;++r){let a=e[r].setByIndices("indices","input[global_idx]");t===1?i.push(a):r===0?i.push(`if (output_number == ${r}u) { ${a} }`):r===t-1?i.push(`else { ${a} }`):i.push(`else if (output_number == ${r}) { ${a} }`)}return`
      fn writeBufferData(output_number: u32, indices: ${e[0].type.indices}, global_idx: u32) {
        ${i.join(`
`)}
      }`},er=(e,t)=>{let i=e[0].dims,r=k.size(i),a=e[0].dataType,s=k.normalizeAxis(t.axis,i.length),n=new Array(t.numOutputs),o=S("input",a,i.length),u=new Array(t.numOutputs),l=[],d=[],p=0,h=[{type:12,data:r}];for(let f=0;f<t.numOutputs;f++){p+=t.splitSizes[f],u[f]=p;let m=i.slice();m[s]=t.splitSizes[f],d.push(m),n[f]=B(`output${f}`,a,m.length),l.push({dims:d[f],dataType:e[0].dataType})}h.push({type:12,data:u},...D(i,...d));let c=f=>`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${o};${h}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:f,dataType:1}],dispatchGroup:{x:p},programUniforms:y}),getShaderSource:_},{inputs:[t,i,r],outputs:[-1]})[0]},Ru=(e,t,i)=>{let r=t[0].dims,a=r,s=2,n=r[0],o=r[1],u=k.sizeFromDimension(r,s),l=ee(u),d=k.size(a)/l,p=ir(e,t[0],t[1],t[2],n,u,o,i.epsilon),h=[n,o,u/l],c=[n,o],f=["type","none"],m=y=>{let _=S("x",t[0].dataType,h.length,l),g=S("scale_shift",1,c.length,2),w=B("output",t[0].dataType,h.length,l),$=[_,g,w];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:y},{inputs:[t[0],m]})},Mu=(e,t)=>{t.format==="NHWC"?Du(e,e.inputs,t):Ru(e,e.inputs,t)}}),Uu,Pu,Nu,qp=z(()=>{P(),q(),L(),Uu=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Pu=(e,t,i)=>{let r=t.simplified,a=e[0].dims,s=e[1],n=!r&&e[2],o=a,u=k.normalizeAxis(t.axis,a.length),l=k.sizeToDimension(a,u),d=k.sizeFromDimension(a,u),p=k.size(s.dims),h=n?k.size(n.dims):0;if(p!==d||n&&h!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
  ...
  ${b.mainStart()}
    ...
    var mean_vector = ${xi("f32",f)};
    var mean_square_vector = ${xi("f32",f)};
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},$=[{dims:o,dataType:e[0].dataType}];return _&&$.push({dims:c,dataType:1}),g&&$.push({dims:c,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${f};${i};${r}`,inputDependencies:m},getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:y}),getShaderSource:w}},Nu=(e,t)=>{Uu(e.inputs),e.compute(Pu(e.inputs,t,e.outputCount))}}),qu,Vu,Vp=z(()=>{q(),Pi(),Li(),qu=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Vu=e=>{qu(e.inputs);let t=Je.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let i=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(i<8&&r<8)e.compute(Ui(e.inputs,{activation:""},t));else{let a=t[t.length-2],s=k.size(e.inputs[0].dims.slice(0,-2)),n=k.size(e.inputs[1].dims.slice(0,-2));if(s!==1&&a===1&&n===1){let o=e.inputs[0].reshape([1,s,r]),u=e.inputs[1].reshape([1,r,i]),l=[1,s,i],d=[o,u];e.compute(Ut(d,{activation:""},t,l),{inputs:d})}else e.compute(Ut(e.inputs,{activation:""},t))}}}),Lu,Gu,Wu,Hu,Fu,Lp=z(()=>{P(),q(),te(),L(),Lu=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let i=e[0],r=i.dims.length;if(i.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let a=Math.floor((t.k+t.blockSize-1)/t.blockSize),s=t.blockSize/8*t.bits,n=e[1];if(!k.areEqual(n.dims,[t.n,a,s]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let o=e[2].dims;if(k.size(o)!==t.n*a)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.bits>4?t.n*a:t.n*Math.floor((a+1)/2);if(k.size(u)!==l)throw new Error("zeroPoints input size error.")}},Gu=(e,t)=>{let i=e[0].dims,r=i.length,a=i[r-2],s=t.k,n=t.n,o=i.slice(0,r-2),u=k.size(o),l=e[1].dims[2]/4,d=e[0].dataType,p=ee(t.k),h=ee(l),c=ee(n),f=o.concat([a,n]),m=a>1&&n/c%2===0?2:1,y=k.size(f)/c/m,_=64,g=[],w=[u,a,s/p],$=k.convertShape(e[1].dims).slice();$.splice(-1,1,l/h),g.push(...D(w)),g.push(...D($)),g.push(...D(e[2].dims)),e.length===4&&g.push(...D(k.convertShape(e[3].dims)));let b=[u,a,n/c];g.push(...D(b));let v=x=>{let I=w.length,E=S("a",e[0].dataType,I,p),A=S("b",12,$.length,h),N=S("scales",e[2].dataType,e[2].dims.length),G=[E,A,N],U=e.length===4?S("zero_points",12,e[3].dims.length):void 0;U&&G.push(U);let V=b.length,W=B("output",e[0].dataType,V,c),O=ae(e[0].dataType),j=(()=>{switch(p){case 1:return`array<${O}, 8>`;case 2:return`mat4x2<${O}>`;case 4:return`mat2x4<${O}>`;default:throw new Error(`${p}-component is not supported.`)}})(),J=()=>{let T=`
          // reuse a data
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${h};${y};${m}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:c,dataType:d}],dispatchGroup:{x:$},programUniforms:b}),getShaderSource:E}},Hu=(e,t)=>{Lu(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Wu(e.inputs,t)):e.compute(Gu(e.inputs,t))},Fu=e=>Z(e)}),ju,Ku,Qu,Zu,Xu,Yu,Ju,el,tl,Gp=z(()=>{P(),q(),L(),ju=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Ku=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
      ...
      `},Qu=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
          ...
          `},Zu=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
            ...
            `;return`
              ...
              ${r}
              value = x[offset];
          `},Xu=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
                k = i32(${e.indicesGet("indices",a)}) - ${R("uniforms.pads",a,i)};
                if (k < 0)  {
            ...
            `;return`
              ...
              ${r}
              value = x[offset];
          `},Yu=(e,t,i)=>{switch(i.mode){case 0:return Ku(e,t,i.pads.length);case 1:return Qu(e,t,i.pads.length);case 2:return Zu(e,t,i.pads.length);case 3:return Xu(e,t,i.pads.length);default:throw new Error("Invalid mode")}},Ju=(e,t)=>{let i=k.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,a=k.size(i),s=[{type:12,data:a},{type:6,data:t.pads}],n=e.length>=3&&e[2].data;t.mode===0&&s.push({type:n?e[2].dataType:1,data:t.value}),s.push(...D(e[0].dims,i));let o=["rank"],u=l=>{let d=B("output",e[0].dataType,i.length),p=S("x",e[0].dataType,r.length),h=p.type.value,c=Yu(d,r.length,t),f=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&f.push({name:"constant_value",type:n?h:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},sr=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,il=e=>`${sr(e)};${e.countIncludePad}`,rl=e=>`${sr(e)};${e.storageOrder};${e.dilations}`,or=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),ur=(e,t,i,r)=>{let[a,s]=rr(t,r,i),n=S("x",t.dataType,t.dims.length),o=n.type.value,u="value += x_val;",l="";a.countIncludePad?l+=`value /= ${o}(uniforms.kernelSize);`:l+=`value /= ${o}(i32(uniforms.kernelSize) - pad);`;let[d,p,h,c,f]=ar(s,a);d.push(...D(t.dims,s));let m=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${h};${c};${f}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(k.size(s)/64)},programUniforms:d}),getShaderSource:y=>nr(y,n,t.dims.length,s.length,a,u,l,0,p,h,c,f)}},al=e=>{let t=e.count_include_pad!==0,i=or(e);if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...i,cacheKey:""};return{...r,cacheKey:il(r)}},nl=(e,t)=>{yt(e.inputs),e.compute(ur("AveragePool",e.inputs[0],!1,t))},lr={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},sl=e=>{let t=e.format;return{format:t,...lr,cacheKey:t}},ol=(e,t)=>{yt(e.inputs),e.compute(ur("GlobalAveragePool",e.inputs[0],!0,t))},dr=(e,t,i,r)=>{let[a,s]=rr(t,r,i),n=`
      value = max(x_val, value);
    `,o="",u=S("x",t.dataType,t.dims.length),l=["rank"],[d,p,h,c,f]=ar(s,a);return d.push(...D(t.dims,s)),{name:e,shaderCache:{hint:`${r.cacheKey};${h};${c};${f}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(k.size(s)/64)},programUniforms:d}),getShaderSource:m=>nr(m,u,t.dims.length,s.length,a,n,o,t.dataType===10?-65504:-1e5,p,h,c,f)}},ul=(e,t)=>{yt(e.inputs),e.compute(dr("MaxPool",e.inputs[0],!1,t))},ll=e=>{let t=e.storage_order,i=e.dilations,r=or(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:i,...r,cacheKey:""};return{...a,cacheKey:rl(a)}},dl=e=>{let t=e.format;return{format:t,...lr,cacheKey:t}},pl=(e,t)=>{yt(e.inputs),e.compute(dr("GlobalMaxPool",e.inputs[0],!0,t))}}),hl,cl,fl,ml,Hp=z(()=>{P(),q(),te(),L(),hl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,r)=>i===e[2].dims[r]).reduce((i,r)=>i&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,s)=>s===t.axis||a===e[0].dims[s]).reduce((a,s)=>a&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/r)||t.blockSize>Math.ceil(i/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},cl=(e,t)=>{let i=k.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,a=r===3,s=e[0].dims,n=e[1].dataType,o=k.size(s),u=r===3||r===2,l=u?[Math.ceil(k.size(e[0].dims)/4)]:e[0].dims,d=e[1].dims,p=e.length>2?e[2]:void 0,h=p?u?[Math.ceil(k.size(p.dims)/4)]:p.dims:void 0,c=d.length===0||d.length===1&&d[0]===1,f=c===!1&&d.length===1,m=ee(o),y=c&&(!u||m===4),_=y?m:1,g=y&&!u?m:1,w=S("input",u?12:r,l.length,g),$=S("scale",n,d.length),b=p?S("zero_point",u?12:r,h.length):void 0,v=B("output",n,s.length,_),x=[w,$];b&&x.push(b);let I=[l,d];p&&I.push(h);let E=[{type:12,data:o/_},{type:12,data:i},{type:12,data:t.blockSize},...D(...I,s)],A=N=>{let G=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getShaderSource:A,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(o/_/64),y:1,z:1},programUniforms:E})}},fl=(e,t)=>{hl(e.inputs,t),e.compute(cl(e.inputs,t))},ml=e=>Z({axis:e.axis,blockSize:e.blockSize})}),gl,_l,yl,Fp=z(()=>{we(),P(),L(),gl=(e,t,i)=>{let r=e===t,a=e<t&&i<0,s=e>t&&i>0;if(r||a||s)throw new Error("Range these inputs' contents are invalid.")},_l=(e,t,i,r)=>{let a=Math.abs(Math.ceil((t-e)/i)),s=[a],n=a,o=[{type:12,data:n},{type:r,data:e},{type:r,data:i},...D(s)],u=l=>{let d=B("output",r,s.length),p=d.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:p},{name:"delta",type:p}];return`
        ${l.registerUniforms(h).declareVariables(d)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${p}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:r}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:o})}},yl=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),Y.webgpu.validateInputContent&&gl(t,i,r),e.compute(_l(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),$l,wl,bl,vl,jp=z(()=>{P(),q(),te(),L(),$l=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let a=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,s=`;
              ...
              ${a}bitcast<${r}>(oldValue) + (${i})${s}`;case"max":return r==="i32"||r==="u32"?`atomicMax(&${t}, bitcast<${r}>(${i}));`:`
                ${a}max(bitcast<f32>(oldValue), (${i}))${s}`;case"min":return r==="i32"||r==="u32"?`atomicMin(&${t}, bitcast<${r}>(${i}));`:`${a}min(bitcast<${r}>(oldValue), (${i}))${s}`;case"mul":return`${a}(bitcast<${r}>(oldValue) * (${i}))${s}`;default:throw new Error(`Reduction ${e} is not supported.`)}},wl=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i,s=1,n=Math.ceil(k.size(r)/s),o=r[r.length-1],u=k.sizeFromDimension(i,o),l=[{type:12,data:n},{type:12,data:o},{type:12,data:u},...D(e[1].dims,e[2].dims,a)],d=p=>{let h=S("indices",e[1].dataType,e[1].dims.length),c=S("updates",e[2].dataType,e[2].dims.length,s),f=t.reduction!=="none"&&t.reduction!==""?Ca("output",e[0].dataType,a.length):B("output",e[0].dataType,a.length,s);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${$l(t.reduction,"output[data_offset + i]","value",f.type.value)}
  }

      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:l}),getShaderSource:d}},bl=e=>Z({reduction:e.reduction}),vl=(e,t)=>{e.compute(wl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),xl,kl,Sl,pr,Il,Tl,zl,El,Cl,Ol,Al,Bl,hr,Rl,Dl,Ml,Ul,Pl,Nl,ql,Kp=z(()=>{P(),q(),te(),L(),xl=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},kl=(e,t,i)=>{t.every(a=>a>=0&&a<i||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let r=new Array(i).fill(1);return t.forEach((a,s)=>r[a]=e[s]),r},Sl=(e,t,i,r,a,s)=>{let[n,o,u]=i>10?[1,2,3]:[-1,e.length>1?1:-1,-1],l=e[0].dims.length;if(n>0&&e.length>n&&e[n].dims.length>0)e[n].getFloat32Array().forEach(d=>s.push(d));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(o>0&&e.length>o&&e[o].dims.length===1&&e[o].dims[0]>0){if(e[o].getFloat32Array().forEach(d=>r.push(d)),r.length!==0&&r.length!==l&&i>=18&&r.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");xl(r,t),t.axes.length>0&&kl(r,t.axes,l).forEach((d,p)=>r[p]=d)}if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0&&(e[u].getBigInt64Array().forEach(d=>a.push(Number(d))),a.length!==0&&a.length!==l&&i>=18&&a.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(r.length!==0&&r.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(a.length!==0&&a.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof r<"u"&&typeof a<"u"&&r.length>0&&a.length>l)throw new Error("Resize requires only of scales or sizes to be specified")},pr=(e,t,i,r)=>`
  ...
  return whole + fract;
`,Il=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
          if (xScale < 1.0 || floor(xScale) != xScale) {
            return ${t}(xResized) / ${t}(xScale);
          } else {
            ${pr("xResized","lengthOriginal","lengthResized",t)}
          }
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                    ...
                    ${pr("xResized","lengthOriginal - 1","lengthResized - 1",t)}
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Tl=(e,t,i)=>`fn getNearestPixelFromOriginal(xOriginal: ${i}, isDownSample: bool) -> ${i} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",zl=(e,t,i)=>{let r=new Array(i).fill(0).concat(new Array(i).fill(1)),a=e.length===0?r:e.slice();return t.length>0?(t.forEach((s,n)=>{r[s]=a[n],r[n+i]=a[t.length+n]}),r):a},El=(e,t,i,r)=>{let a=[];if(i.length>0)if(r.length>0){if(e.forEach(s=>a.push(s)),Math.max(...r)>e.length)throw new Error("axes is out of bound");r.forEach((s,n)=>a[s]=i[n])}else i.forEach(s=>a.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");a=e.map((s,n)=>Math.round(s*t[n]))}return a},Cl=(e,t,i)=>{let r=(()=>{switch(i.keepAspectRatioPolicy){case"not_larger":return i.axes.length>0?Math.min(...i.axes.map(s=>t[s]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return i.axes.length>0?Math.max(...i.axes.map(s=>t[s]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${i.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let a=e.slice();return i.axes.length>0?(i.axes.forEach(s=>t[s]=r),i.axes.forEach(s=>a[s]=Math.round(e[s]*t[s]))):(t.fill(r,0,t.length),a.forEach((s,n)=>a[n]=Math.round(s*t[n]))),a},Ol=(e,t,i,r,a)=>`
...
`:"",Rl=(e,t,i,r,a)=>{let[s,n,o,u]=i.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},Dl=(e,t,i,r,a,s,n,o,u,l)=>{let d=i.length===2,[p,h]=d?[0,1]:[2,3],c=e.type.value,f=m=>{let y=m===p?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${c} {
    ...
    `},Ml=(e,t,i,r,a)=>{let[s,n,o,u,l]=i.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],d=e.type.value;return`
    ...
    }`},Ul=(e,t,i,r,a,s)=>{let n=e.dims,o=zl(s,t.axes,n.length),u=El(n,r,a,t.axes),l=r.slice();r.length===0&&(l=n.map((g,w)=>g===0?1:u[w]/g),t.keepAspectRatioPolicy!=="stretch"&&(u=Cl(n,l,t)));let d=B("output",e.dataType,u.length),p=S("input",e.dataType,n.length),h=k.size(u),c=n.length===u.length&&n.every((g,w)=>g===u[w]),f=t.coordinateTransformMode==="tf_crop_and_resize",m=t.extrapolationValue,y=p.type.value,_=g=>`
      ${c?"":`
      ${Il(t.coordinateTransformMode,y)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${Bl(p,n)};
              ${Tl(t.nearestMode,i,y)};
              ${Al(p,d,n,u,l.length,o.length,f)};
              `;case"linear":return`
              ${Ol(d,n,u,l.length,o.length)};
              ${(()=>{if(n.length===2||n.length===4)return`${Rl(p,d,n,f,m)}`;if(n.length===3||n.length===5)return`${Ml(p,d,n,f,m)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(n.length===2||n.length===4)return`${Dl(p,d,n,u,l,o,t.cubicCoeffA,f,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${i}|${l.length>0?t.mode==="cubic"?l:l.length:""}|${a.length>0?a:""}|${o.length>0?o:""}|${c}|${t.mode==="nearest"?n.length:n}`,inputDependencies:["rank"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:[{type:12,data:h},{type:1,data:l},{type:1,data:o},...D(n,u)]})}},Pl=e=>{let t=e.customDataBuffer;return new Uint32Array(t,t.byteOffset,1)[0]},Nl=(e,t)=>{let i=[],r=[],a=[],s=Pl(e);if(t.antialias!==0)throw Error("Only default value (0) for Antialias attribute is supported");Sl(e.inputs,t,s,i,r,a),e.compute(Ul(e.inputs[0],t,s,i,r,a),{inputs:[0]})},ql=e=>{let t=e.antialias,i=e.axes,r=e.coordinateTransformMode,a=e.cubicCoeffA,s=e.excludeOutside!==0,n=e.extrapolationValue,o=e.keepAspectRatioPolicy,u=e.mode,l=e.nearestMode===""?"simple":e.nearestMode;return Z({antialias:t,axes:i,coordinateTransformMode:r,cubicCoeffA:a,excludeOutside:s,extrapolationValue:n,keepAspectRatioPolicy:o,mode:u,nearestMode:l})}}),Vl,Ll,Gl,Qp=z(()=>{P(),q(),te(),L(),Vl=(e,t)=>{let[i,r,a,s]=e,{numHeads:n,rotaryEmbeddingDim:o}=t;if(i.dims.length!==3&&i.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${i.dims.length}`);if(!k.areEqual(r.dims,[])&&!k.areEqual(r.dims,[1])&&r.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(s.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${s.dims.length}`);if(!k.areEqual(a.dims,s.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(o>0&&n===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=i.dims[0],l=i.dims[i.dims.length-2],d=a.dims[0],p=k.sizeFromDimension(i.dims,1)/l,h=o===0?a.dims[1]*2:p/n;if(o>h)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(r.dims.length===2){if(u!==r.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`);if(l!==r.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`)}if(h/2!==a.dims[1]&&o/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`);if(l>d)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},Ll=(e,t)=>{let{interleaved:i,numHeads:r,rotaryEmbeddingDim:a,scale:s}=t,n=e[0].dims[0],o=k.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],l=o/u,d=e[2].dims[1],p=a===0?d*2:l/r,h=new Array(n,u,l/p,p-d),c=k.computeStrides(h),f=[{type:1,data:s},{type:12,data:h},{type:12,data:c},...e[0].dims.length===3?new Array({type:12,data:[o,l,p,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[o,p,u*p,1]}):[],...D(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],m=y=>{let _=S("input",e[0].dataType,e[0].dims.length),g=S("position_ids",e[1].dataType,e[1].dims.length),w=S("cos_cache",e[2].dataType,e[2].dims.length),$=S("sin_cache",e[3].dataType,e[3].dims.length),b=B("output",e[0].dataType,e[0].dims.length);return y.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:h.length},{name:"global_strides",type:"u32",length:c.length},{name:"input_output_strides",type:"u32",length:c.length}]),`
      ...
      }`},$=[{dims:o,dataType:e[0].dataType}];return i>1&&$.push({dims:d,dataType:1}),i>2&&$.push({dims:d,dataType:1}),i>3&&$.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${_};${c};${f};${m}`,inputDependencies:e.map((b,v)=>"type")},getShaderSource:w,getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:g})}},Fl=(e,t)=>{Wl(e.inputs);let i=[0];e.outputCount>1&&i.push(-3),e.outputCount>2&&i.push(-3),e.outputCount>3&&i.push(3),e.compute(Hl(e.inputs,t,e.outputCount,!1),{outputs:i})}}),jl,$t,Kl,cr,Ql,Zl,Xl,Yl,Xp=z(()=>{P(),q(),te(),L(),jl=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((i,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},$t=(e,t)=>{let i=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>i.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>i.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return i},Kl=(e,t)=>{if(e.length>1){let i=$t(e,1),r=$t(e,2),a=$t(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),Z({starts:i,ends:r,axes:a})}else return t},cr=(e,t,i,r,a)=>{let s=e;return e<0&&(s+=i[r[t]]),a[t]<0?Math.max(0,Math.min(s,i[r[t]]-1)):Math.max(0,Math.min(s,i[r[t]]))},Ql=(e,t,i)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${n.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:m})}},Xl=(e,t)=>{jl(e.inputs,t);let i=Kl(e.inputs,t);e.compute(Zl(e.inputs,i),{inputs:[0]})},Yl=e=>{let t=e.starts,i=e.ends,r=e.axes;return Z({starts:t,ends:i,axes:r})}}),Jl,ed,td,id,Yp=z(()=>{P(),q(),te(),Ae(),L(),Jl=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},ed=(e,t)=>{let i=e.inputs[0],r=i.dims,a=k.size(r),s=r.length,n=k.normalizeAxis(t.axis,s),o=n<r.length-1,u,l=[];o?(l=Array.from({length:s},(x,I)=>I),l[n]=s-1,l[s-1]=n,u=e.compute(fe(i,l),{inputs:[i],outputs:[-1]})[0]):u=i;let d=u.dims,p=d[s-1],h=a/p,c=ee(p),f=p/c,m=64;h===1&&(m=256);let y=(x,I)=>I===4?`max(max(${x}.x, ${x}.y), max(${x}.z, ${x}.w))`:I===2?`max(${x}.x, ${x}.y)`:I===3?`max(max(${x}.x, ${x}.y), ${x}.z)`:x,_=S("x",u.dataType,u.dims,c),g=B("result",u.dataType,u.dims,c),w=_.type.value,$=ae(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,b=x=>`
      ...
      }`,v=e.compute({name:"Softmax",shaderCache:{hint:`${c};${m}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:d,dataType:u.dataType}],dispatchGroup:{x:h},programUniforms:[{type:6,data:f}]}),getShaderSource:b},{inputs:[u],outputs:[o?-1:0]})[0];o&&e.compute(fe(v,l),{inputs:[v]})},td=(e,t)=>{Jl(e.inputs),ed(e,t)},id=e=>Z({axis:e.axis})}),fr,rd,ad,nd,sd,Jp=z(()=>{P(),q(),L(),fr=e=>Array.from(e.getBigInt64Array(),Number),rd=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, float16, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(fr(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},ad=(e,t)=>{let i=[];for(let r=0;r<e.length;++r)i.push(e[r]*t[r]);return i},nd=(e,t)=>{let i=e[0].dims,r=t??fr(e[1]),a=ad(i,r),s=k.size(a),n=e[0].dataType,o=S("input",n,i.length),u=B("output",n,a.length),l=d=>`
 ...
 * limitations under the License.
 * =============================================================================
 */De.exports=at})(Gd);var Fd=Gd.exports;const gh=fh(Fd),$h=mh({__proto__:null,default:gh},[Fd]);export{$h as o};
//# sourceMappingURL=ort.min-f571ca7c.js.map
